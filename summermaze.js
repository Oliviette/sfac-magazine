...
function Position(x, y) {
  ...
  Mazing.prototype.heroTakeTreasure = function() {
    ...
    this.heroScore += 10;
    this.setMessage("yay, bonus points!");
  };
  ...
  Mazing.prototype.heroTakeKey = function() {
    ...
    this.setMessage("yummm...now find the planet!");
  };
  ...
  Mazing.prototype.heroWins = function() {
    ...
    this.heroScore += 50;
    this.gameOver("congrats, you reached home!");
  };
  ...
  Mazing.prototype.tryMoveHero = function(pos) {
    ...
    if(nextStep.match(/exit/)) {
      if(this.heroHasKey) {
        ...
        this.setMessage("you need to eat the plant first!");
        return;
      }
    }
  ...
  Mazing.prototype.setChildMode = function() {
    this.childMode = true;
    this.heroScore = 0;
    this.setMessage("go the cake and then the planet!");
  };